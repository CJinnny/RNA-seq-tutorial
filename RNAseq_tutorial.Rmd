...
```{r warning=FALSE}
summary <- merge(summary, DESeq_res[,c("id", "log2FoldChange","padj")], by = "id")
setnames(summary, old = c("log2FoldChange", "padj"), new = c("DESeq_logFC", "DESeq_padj"))
summary <- merge(summary, DESeq2_res[,c("id", "log2FoldChange","padj")], by = "id")
setnames(summary, old = c("log2FoldChange", "padj"), new = c("DESeq2_logFC", "DESeq2_padj"))
summary <- merge(summary, edgeR_res[,c("id", "logFC", "FDR")], by = "id")
setnames(summary, old = c("logFC", "FDR"), new = c("edgeR_logFC", "edgeR_padj"))
summary <- merge(summary, limma_res[,c("id", "logFC", "adj.P.Val")], by = "id")
setnames(summary, old = c("logFC", "adj.P.Val"), new = c("limma_logFC", "limma_padj"))
summary = summary[,c(1,9,10,11,12,13,14,15,16,6,7,8)]
